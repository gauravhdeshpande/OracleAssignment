            ...
            <div class="col-lg-7 col-xs-12">
                ...
                <ul class="btn-ul">
                    ${this.json.details.sizes.map((el,id)=>{
                        console.log(el,id);
                        return '<li><p class="sizeContainer"><input id="radio'+id+'" value="'+el+'" type="checkbox" class="sizeBtn" name="size"><label style="text-transform:capitalize;" class="customRadio" for="radio'+id+'"><span class="firstLetter">'+el.substr(0,1)+'</span><span class="ax-hidden">'+el.substr(1)+'</span></label></p></li>'
